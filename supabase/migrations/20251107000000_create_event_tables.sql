...
--
-- ID Format Structure:
-- - Events: evt-[timestamp]-[random8]  (example: evt-1730900000-abc123d4)
-- - Participants: prt-[timestamp]-[random8]  (example: prt-1730900000-xyz789w2)
-- - Agenda: agd-[timestamp]-[random8]  (example: agd-1730900000-efg456h8)
-- - Custom Fields: fld-[timestamp]-[random8]  (example: fld-1730900000-qwe123r5)
--
-- Security Model:
